...
Route::post('/klanten/', [KlantController::class, 'store'])->name('klanten.bewaar');
Route::put('/klanten/{id}', [KlantController::class, 'update'])->name('klanten.update');
Route::delete('/klanten/{id}', [KlantController::class, 'destroy'])->name('klanten.verwijder');
...
Route::get('/klanten/bewerk/{id}', function ($id) {
    $klant = Klant::find($id);
    $allergenen = Allergy::all();
